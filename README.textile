...
| Daniel Kehoe | "Devise, Mongoid":https://github.com/fortuity/rails3-mongoid-devise | Detailed tutorial, app template, starter app, using MongoDB |
...
The app has been tested with the indicated versions. If you are able to build the app with a newer gem, please create a "GitHub issue":http://github.com/RailsApps/rails3-mongoid-omniauth/issues. and I will update the app.
...
You can browse and search the Cucumber features at the "Relish":http://relishapp.com/RailsApps/rails3-mongoid-omniauth website.
...
Please create a "GitHub issue":http://github.com/RailsApps/rails3-mongoid-omniauth/issues. if you identify any problems or have suggestions for improvements.
